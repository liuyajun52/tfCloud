...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.registButton).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent re=new Intent(LoginActivity.this,RegistActivity.class);
				startActivity(re);			
			}
		});
	}
	...
	public class UserLoginTask extends AsyncTask<String, Void, Boolean> {
		...
		protected Boolean doInBackground(String... params) {
			...
			try {
				InputStream in = new StreamGetter(ApiAddress.getLOGIN_API(),
						paramsMap).getIn();
				if(in==null){
					return false;
				}
				user = UserParser.parse(in);
				return true;
